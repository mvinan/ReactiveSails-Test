...
/**
 * First bundle, then serve from the ./../assets directory
 */
gulp.task('default', gulpsync.sync(['bundle','inject:sass', 'styles']), function () {
    // browserSync.init({
    //     server: "../assets"
    // });
...
gulp.task('inject:HTML', function () {
  ...
  // It's not necessary to read the files (will speed up things), we're only after their paths:
  var sources = gulp.src(['../assets/js/*.js','../assets/styles/*.css'], {read: false});
